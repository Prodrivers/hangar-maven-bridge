...
@router.get("/repository/io/papermc/hangar/{platform}/{channel}/{slug}/maven-metadata.xml", response_class=XmlAppResponse, response_model=metadata, tags=["with_platform_and_channel"])
...
@router.get("/repository/io/papermc/hangar/{platform}/{slug}/maven-metadata.xml", response_class=XmlAppResponse, response_model=metadata, tags=["with_platform"])
@cache(expire=settings.cache.metadata_expiration)
