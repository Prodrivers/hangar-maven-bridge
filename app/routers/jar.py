...
@router.get("/repository/io/papermc/hangar/{platform}/{channel}/{slug}/{version}/{filename}.jar", response_class=RedirectResponse, tags=["hangar_with_platform_and_channel"])
...
@router.get("/repository/io/papermc/hangar/{platform}/{slug}/{version}/{filename}.jar", response_class=RedirectResponse, tags=["hangar_with_platform"])
